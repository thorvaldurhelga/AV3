...
for i = 1 : 3 
    ...
    cornerPnt = getClosestPointToPoint(R,planePoints(i,:))

    % select a random small surface patch from the remaining points
    [oldlist,plane] = select_patches(remaining,cornerPnt);	%-- oldlist is the list of points in the patch, plane is the best fit for the patch
